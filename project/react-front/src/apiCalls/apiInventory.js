...
export const getAllMeats = (token, userId) => {
    ...
    return fetch(`${process.env.REACT_APP_API_URL}/ingredientCategoryHave/${userId}?cat=meat`, requestContent)
    .then( response => {
...
export const getEmptyMeats = (token, userId) => {
    ...
    // fetch to the backend
    return fetch(`${process.env.REACT_APP_API_URL}/ingredientCategoryDont/${userId}?cat=meat`, requestContent)
    .then( response => {
        return response.json();
    })
    .catch(err => console.log(err));
...
export const getAllVegetables = (token, userId) => {
    ...
    // fetch to the backend
    return fetch(`${process.env.REACT_APP_API_URL}/ingredientCategoryHave/${userId}?cat=vegetable`, requestContent)
    .then( response => {
        return response.json();
    })
    .catch(err => console.log(err));
...
export const getEmptyVegetables = (token, userId) => {
    ...
    // fetch to the backend
    return fetch(`${process.env.REACT_APP_API_URL}/ingredientCategoryDont/${userId}?cat=vegetable`, requestContent)
    .then( response => {
        return response.json();
    })
    .catch(err => console.log(err));
...
export const getAllFruit = (token, userId) => {
    ...
    // fetch to the backend
    return fetch(`${process.env.REACT_APP_API_URL}/ingredientCategoryHave/${userId}?cat=fruit`, requestContent)
    .then( response => {
        return response.json();
    })
    .catch(err => console.log(err));
...
export const getEmptyFruit = (token, userId) => {
    ...
    // fetch to the backend
    return fetch(`${process.env.REACT_APP_API_URL}/ingredientCategoryDont/${userId}?cat=fruit`, requestContent)
    .then( response => {
        return response.json();
    })
    .catch(err => console.log(err));
...
export const getAllDairy = (token, userId) => {
    ...
    // fetch to the backend
    return fetch(`${process.env.REACT_APP_API_URL}/ingredientCategoryHave/${userId}?cat=dairy`, requestContent)
    .then( response => {
        return response.json();
    })
    .catch(err => console.log(err));
...
export const getEmptyDairy = (token, userId) => {
    ...
    // fetch to the backend
    return fetch(`${process.env.REACT_APP_API_URL}/ingredientCategoryDont/${userId}?cat=dairy`, requestContent)
    .then( response => {
        return response.json();
    })
    .catch(err => console.log(err));
...
export const getAllSpices = (token, userId) => {
    ...
    // fetch to the backend
    return fetch(`${process.env.REACT_APP_API_URL}/ingredientCategoryHave/${userId}?cat=spices`, requestContent)
    .then( response => {
        return response.json();
    })
    .catch(err => console.log(err));
...
export const getEmptySpices = (token, userId) => {
    ...
    // fetch to the backend
    return fetch(`${process.env.REACT_APP_API_URL}/ingredientCategoryDont/${userId}?cat=spices`, requestContent)
    .then( response => {
        return response.json();
    })
    .catch(err => console.log(err));
...
export const getAllMiscellaneous = (token, userId) => {
    ...
    // fetch to the backend
    return fetch(`${process.env.REACT_APP_API_URL}/ingredientCategoryHave/${userId}?cat=miscellaneous`, requestContent)
    .then( response => {
        return response.json();
    })
    .catch(err => console.log(err));
...
export const getEmptyMiscellaneous = (token, userId) => {
    ...
    // fetch to the backend
    return fetch(`${process.env.REACT_APP_API_URL}/ingredientCategoryDont/${userId}?cat=miscellaneous`, requestContent)
    .then( response => {
        return response.json();
    })
    .catch(err => console.log(err));
