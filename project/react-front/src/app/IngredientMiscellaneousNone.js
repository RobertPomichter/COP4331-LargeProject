...
class IngredientMiscellaneousNone extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ingredientId: "",
    ...
    componentDidMount() {
        this.setState({ ingredientId: this.props.ingredientId,
                        name: this.props.miscellaneousName,
                        unit: this.props.miscellaneousUnit,
                        amount: this.props.miscellaneousAmount});
    }
    ...
    render() {
        return (
            <div className='ingredientContainer'>
                    ...
                    <div className='ingredientNoMiscellaneousCircleContainer'>
                        <img className='ingredientImage' src={GenericMiscellaneousPicture}></img>
                    </div>
                    <span className='miscellaneousName'>{this.state.name}</span>
                    <br/>
                    <span className='miscellaneousAmount'>{this.state.amount}</span>
                    {" "}
                    <span className='miscellaneousUnit'>{this.state.unit}</span>
                    <br />
...
export default IngredientMiscellaneousNone;