...
class IngredientDairyNone extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ingredientId: "",
    ...
    componentDidMount() {
        this.setState({ ingredientId: this.props.ingredientId,
                        name: this.props.dairyName,
                        unit: this.props.dairyUnit,
                        amount: this.props.dairyAmount});
    }
    ...
    render() {
        return (
            <div className='ingredientContainer'>
                    ...
                    <div className='ingredientNoDairyCircleContainer'>
                        <img className='ingredientImage' src={GenericDairyPicture}></img>
                    </div>
                    <span className='dairyName'>{this.state.name}</span>
                    <br/>
                    <span className='dairyAmount'>{this.state.amount}</span>
                    {" "}
                    <span className='dairyUnit'>{this.state.unit}</span>
                    <br />
...
export default IngredientDairyNone;