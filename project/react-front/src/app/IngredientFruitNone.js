...
class IngredientFruitNone extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ingredientId: "",
    ...
    componentDidMount() {
        this.setState({ ingredientId: this.props.ingredientId,
                        name: this.props.fruitName,
                        unit: this.props.fruitUnit,
                        amount: this.props.fruitAmount});
    }
    ...
    render() {
        return (
            <div className='ingredientContainer'>
                    ...
                    <div className='ingredientNoFruitCircleContainer'>
                        <img className='ingredientImage' src={GenericFruitPicture}></img>
                    </div>
                    <span className='fruitName'>{this.state.name}</span>
                    <br/>
                    <span className='fruitAmount'>{this.state.amount}</span>
                    {" "}
                    <span className='fruitUnit'>{this.state.unit}</span>
                    <br />
...
export default IngredientFruitNone;